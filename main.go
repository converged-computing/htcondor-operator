...
import (
	...
	controllers "github.com/converged-computing/htcondor-operator/controllers/htcondor"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "8258755d.flux-framework.org",
	...
	if err = (&controllers.HTCondorReconciler{
